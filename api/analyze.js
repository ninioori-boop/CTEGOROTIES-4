...
- אם כתוב "ביטול עסקה" או "החזר" או "זיכוי" - זה החזר! הסכום צריך להיות שלילי!
- שמור את הסימן השלילי ב-amount! לדוגמה: -65.2
- החזרים יכולים להופיע כ: "-65.2" או "(65.2)" או "65.2-"
- הוסף "החזר" לתחילת התיאור של החזרים!
- דוגמאות:
  ✅ "SHEIN ביטול עסקה 65.2" → {"description": "החזרSHEIN", "amount": -65.2, "category": "ביגוד והנעלה"}
  ✅ "בלוברי החזר 85" → {"description": "החזרבלוברי", "amount": -85, "category": "ביגוד והנעלה"}`;
